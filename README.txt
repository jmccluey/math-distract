...
pyEPL is required, and the project must be on your path.

Authors
=====

Neal Morton wrote this project partially based on code from vcdMathMod.py (written by unknown members of the Kahana lab), and other code by Josh McCluey.
